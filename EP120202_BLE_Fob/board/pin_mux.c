...
#else
    /* PORTA17 (pin ) is configured as LPUART0_RX */
    PORT_SetPinMux(PORTA, 17U, kPORT_MuxAlt3);

    /* PORTA18 (pin ) is configured as LPUART0_TX */
...
void BOARD_InitButtons(void)
{
    ...
    // gpio_pin_config_t PB0_config = {
    //     .pinDirection = kGPIO_DigitalInput,
    //     .outputLogic = 0U
    // };
    // GPIO_PinInit(GPIOB, 0U, &PB0_config);

    // gpio_pin_config_t PB1_config = {
    //     .pinDirection = kGPIO_DigitalInput,
    //     .outputLogic = 0U
    // };
    // GPIO_PinInit(GPIOB, 1U, &PB1_config);

    // gpio_pin_config_t PB2_config = {
    //     .pinDirection = kGPIO_DigitalInput,
    //     .outputLogic = 0U
    // };
    // GPIO_PinInit(GPIOB, 2U, &PB2_config);

    // gpio_pin_config_t PB3_config = {
    //     .pinDirection = kGPIO_DigitalInput,
    //     .outputLogic = 0U
    // };
    // GPIO_PinInit(GPIOB, 3U, &PB3_config);
}
