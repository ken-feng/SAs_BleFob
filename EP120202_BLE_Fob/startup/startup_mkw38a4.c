...
extern void SystemInitWarm(void);
#endif
#endif // (__USE_CMSIS)
...
WEAK void LPUART0_LPUART1_IRQHandler(void);
...
WEAK void CAN0_MB_IRQHandler(void);
...
void LPUART0_LPUART1_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void (* const g_pfnVectors[])(void) = {
    ...
    CAN0_IRQHandler,             // 27: FlexCAN0 ORed Error, Bus off, Transmit/Receive Warning, Wake up
    LPUART0_LPUART1_IRQHandler,  // 28: LPUART0 or LPUART1 status and error
    ...
    CAN0_MB_IRQHandler,          // 41: FlexCAN0 ORed Message Buffer (MB0-31) interrupt
...
WEAK_AV void DSB_IRQHandler(void)
...
WEAK_AV void LPUART0_LPUART1_IRQHandler(void)
...
WEAK_AV void CAN0_MB_IRQHandler(void)
{   CAN0_DriverIRQHandler();
}
